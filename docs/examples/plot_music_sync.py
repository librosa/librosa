...
# Plot x_1
librosa.display.waveplot(x_1, sr=fs, axes=axs[0])
axs[0].set(title='Slower Version $X_1$')

# Plot x_2
librosa.display.waveplot(x_2, sr=fs, axes=axs[1])
axs[1].set(title='Slower Version $X_2$')
