...
HTML(librosa.util.example_info("libri2", html=True))

# %%
#

Audio(url=librosa.example("libri2", url=True))
...
for (factor, energy) in zip(harmonics, harmonic_energy, strict=True):
