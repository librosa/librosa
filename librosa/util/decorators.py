...
def moved(*, moved_from, version, version_removed) -> Callable[[_F], _F]:
...
def deprecated(*, version, version_removed) -> Callable[[_F], _F]:
    """This is a decorator which can be used to mark functions
    as deprecated.
...
def vectorize(*, otypes=None, doc=None, excluded=None, cache=False, signature=None) -> Callable[[_F], _F]:
