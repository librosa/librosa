...
@pytest.mark.parametrize('infile',
                         files(os.path.join('tests', 'data', 'met-centroid-*.mat')))
...
@pytest.mark.parametrize('infile',
                         files(os.path.join('tests', 'data', 'met-contrast-*.mat')))
...
@pytest.mark.parametrize('infile',
                         files(os.path.join('tests', 'data', 'met-rolloff-*.mat')))
...
@pytest.mark.parametrize('infile',
                         files(os.path.join('tests', 'data', 'met-bandwidth-*.mat')))
