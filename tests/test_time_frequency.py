...
@pytest.mark.parametrize('frames', [100, np.arange(10.), np.ones((3, 3))],
                                     ids=['0d', '1d', '2d'])
...
@pytest.mark.parametrize('samples', [1024 * 100,
                                     1024 * np.arange(10.),
                                     1024 * np.ones((3, 3))],
                                     ids=['0d', '1d', '2d'])
@pytest.mark.parametrize('hop_length', [512, 1024])
...
@pytest.mark.parametrize('tuning,octave', [(None, None),
                                            (None, 1),
                                            (None, 2),
                                            (None, 3),
                                            (-25, 1),
...
@pytest.mark.parametrize('midi_num,note,octave,cents',
                         [(24.25, 'C', False, False),
                          (24.25, 'C1', True, False),
...
@pytest.mark.parametrize('hz,note,octave,cents', [
                            (440, 'A', False, False),
                            (440, 'A4', True, False),
                            (440, 'A4+0', True, True),
